...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if production < lower_bound:
        return 'LOW'
    elif lower_bound <= production <= upper_bound:
        return 'NORMAL'
    else:
        return 'DANGER'
...
print(is_criticality_balanced(600,200))
print(reactor_efficiency(200,100,58))
print(fail_safe(800,452,36))